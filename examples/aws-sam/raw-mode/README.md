...
```bash
$ aws ecr create-repository --repository-name example-raw-wl-sam-app
```
...
{
    "repository": {
        "repositoryArn": "arn:aws:ecr:us-east-1:123456789012:repository/example-raw-wl-sam-app",
        "registryId": "123456789012",
        "repositoryName": "example-raw-wl-sam-app",
        "repositoryUri": "123456789012.dkr.ecr.us-east-1.amazonaws.com/example-raw-wl-sam-app", 
...
- **Confirm changes before deploy**: If enabled, any change sets will be shown to you for manual review before execution. If disable, the AWS SAM CLI will automatically deploy application changes without prompting for review.
